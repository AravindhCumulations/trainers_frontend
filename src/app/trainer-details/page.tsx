                                        ...
                                        <div className="flex flex-row flex-wrap gap-2 justify-center items-center text-black-500">
                                            {trainerData.expertise_in
                                                ...
                                                .map((skill, index) => (
                                                    <div
                                                        key={index}
                                                        className="rounded-2xl border-2 border-blue-500 px-4 py-1 whitespace-nowrap"
                                                    >
                                                        {skill.trim()}
                                                    </div>
                                                ))}
                                        </div>
                                        <div className="flex flex-row flex-wrap trainer-details justify-center items-center font-normal leading-[24px] text-[16px] text-[#4A5565] gap-x-2 gap-y-2">
                                            {/* Location */}
                            ...
                            <div className="w-[70%] mx-auto">
                                ...
                                <div className="mb-6 rounded-xl bg-white p-6 text-lg font-semibold w-full">
                                    <div className="flex w-full justify-between items-center">
                                        <p className="w-full border-b-2 border-blue-500 text-[18px] font-bold leading-[28px] text-[#1E2939] pb-3">About Me</p>
                                    </div>
                                ...
                                <div className="columns-1 md:columns-2 gap-6 space-y-6">
                                    ...
                                    <div className="break-inside-avoid bg-white rounded-xl p-6">
                                        <div className="flex w-full justify-between items-center">
                                            <p className="w-full border-b-2 border-blue-500 text-[18px] font-bold leading-[28px] text-[#1E2939] pb-3">Training Approach</p>
                                        </div>
                                    ...
                                    <div className="break-inside-avoid bg-white rounded-xl p-6">
                                        <div className="flex w-full justify-between items-center">
                                            <p className="w-full border-b-2 border-blue-500 text-[18px] font-bold leading-[28px] pb-3">Certifications</p>
                                        </div>
                                        <div className="pt-4">
                                            <div className="">
                                                {trainerData.certificates.map((certificate, index) => {
                                                    ...
                                                    return (<div key={index}
                                                        ...
                                                        <div className="flex justify-between">
                                                            <p className="text-[15.88px] font-normal text-[#1E2939] leading-[24px]">{certificate.certificate_name}</p>
                                                            <p className="text-[14px] font-normal text-[#4A5565] leading-[20px]">({certificate.issued_date})</p>
                                                        </div>
                                                        <p className="text-[14px] font-normal text-[#4A5565] leading-[20px]">{certificate.issued_by}</p>
                                                    </div>);
                                                })}
                                            </div>
                                        </div>
                                        ...
                                        <div className="pt-4 flex flex-col gap-4">
                                            {trainerData.testimonilas.map((test, index) => (
                                                <div key={index} className="bg-[#EDF1FF] rounded-xl p-4">
                                                    ...
                                                    <p className="text-[14px] font-normal text-[#4A5565] leading-[20px] py-2">
                                                        {test.testimonials}
                                                    </p>
                                                </div>
                                            ))}
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className={`pt-1 ${isLast ? 'pb-0' : 'pb-8'} pl-2 pr-4`}>
                                                            <p className="text-[16px] font-normal text-[#1E2939] leading-[24px]">
                                                                {education.course}
                                                                &nbsp;&nbsp;
                                                                <span className="text-[#F54900]">({education.year})</span>
                                                            </p>
                                                            <p className="text-[16px] font-normal text-[#1E2939] leading-[24px]">{education.institution}</p>
                                                        </div>
                                                    </div>
                                                );
                                            })}
