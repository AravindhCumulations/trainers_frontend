...
// Workshop Edit Form Component
const WorkshopEditForm = ({ onClose }: { onClose: () => void }) => {
    const [formData, setFormData] = useState<WorkshopFormData>({
        ...
        programFlow: ["Welcome & Ice-breaker", "Interactive activities", "Scenario roleplays", "Scenario roleplays"],
    ...
    return (
        <div className="w-[1024px] flex flex-col mt-4 gap-3 p-6 bg-white rounded-2xl">
            <div className="flex justify-between items-center">
                <p className="text-[36px] font-bold">Edit Workshop</p>
                <button
                    className="text-gray-500 hover:text-gray-800 text-xl font-bold"
                    onClick={onClose}
                    aria-label="Close"
