...
export default function TrainerDetails() {
    ...
    const [trainerLocked, setTrainerLocked] = useState(false);
    ...
    useEffect(() => {
        const fetchTrainerData = async () => {
            try {
                // Get trainer name from URL query params
                ...
                console.log(" User_Name : ", userName, "=> trainer_name : ", trainerName);

                //simple api to perform unlock check
                ...
                if (trainerName) {
                    ...
                    setAboutText(response.data?.bio_line || '');

                    if (response.data.full_name === "Trainer  Yopmail") {
    ...
    const setTrainersData = (response: TrainerDetailsModel) => {
        setAboutText(response.bio_line);
        // setApproachText(response.training_approch);    
    }
                            ...
                            <div className=" profile-card shadow-lg flex flex-col gap-3 justify-center items-center rounded-xl bg-white p-10 h-full">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    {isLoggedInUser && (
                                        <div className="w-full flex justify-center ">
                                            <button onClick={() => handleNavigation('/trainer-form')}
                                ...
                                <div className="flex flex-row flex-wrap trainer-details justify-center items-center font-light leading-[2rem] gap-x-2 gap-y-2">
                                    ...
                                    <p className="flex items-center gap-1">
                                        ...
                                        {trainerData?.language || 'english'} English
                                    </p>
                                </div>
                                ...
                                <div className=" relative border-1 border-gray-100 rounded-xl shadow-lg p-4 trainer-contact w-full">
                                    ...
                                    <div className={`flex flex-col gap-3 ${!isTrainer && trainerLocked ? 'blur-sm' : ''}`}>
                    ...
                    <div className="w-[70%] mx-auto">
                        ...
                        <div className="mb-6 rounded-xl bg-white p-6 text-lg font-semibold">
                            <div className="flex justify-between items-center w-full">
                                <p className={`border-b-2 border-blue-500 text-xl font-semibold pb-3 ${isTrainer && isLoggedIn ? '' : 'w-full'}`}>Workshops</p>
