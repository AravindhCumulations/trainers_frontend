...
const WorkshopCard = ({ workshop, onClick }: WorkshopCardProps) => {
    ...
    const cardClasses = `bg-white border-2 rounded-lg shadow-lg overflow-hidden max-w-lg cursor-pointer h-[300px] w-[20rem] min-w-[20rem] max-w-[20rem] flex flex-col`;
            ...
            <div className="p-2 px-3 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mt-auto">
                    <span className={priceClasses}>
                        ₹ {workshop.price.toFixed(0)}&nbsp;pax/session
                    </span>
